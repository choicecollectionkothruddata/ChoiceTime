...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 animate-slide-up">
      <div className="bg-brown-900 text-white shadow-2xl border-t border-brown-800">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-transparent border border-white rounded-lg hover:bg-gray-800 transition-colors whitespace-nowrap"
              >
                Decline
              </button>
              <button
